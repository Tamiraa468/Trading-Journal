export default function SettingsPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center">
      ...
      <div>
        <h1 className="font-display text-2xl font-semibold text-txt-primary">Settings</h1>
        <p className="mt-1 text-sm text-txt-muted font-mono">Coming soon</p>
      </div>
      <p className="text-sm text-txt-dim max-w-xs">
        Manage your profile, connected accounts, notification preferences, and data export.
      </p>
    </div>
  );
}
